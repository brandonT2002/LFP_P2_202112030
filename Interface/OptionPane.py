...
class OptionPane(tk.Frame):
    ...
    def components(self):
        ...
        self.upload = Button(master=self,text='Cargar Archivo',font=('Roboto Medium',11),bg='#0059b3',activebackground='#0059b3',foreground='white',activeforeground='white',width=15,height=1,cursor='hand2')
